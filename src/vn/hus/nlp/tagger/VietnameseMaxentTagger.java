...
public class VietnameseMaxentTagger {
	...
	/**
	 * Tags a list of words. Each word in the list may be a normal Vietnamese word with spaces separating syllables.
	 * 
	 ...
	 * Tests a file.
	 * 
	 * @param filename a file to test. This file contains words which are correctly tagged by human annotators.
	 */
